...
const Home = () => {
  return (
    ...
    >
      ...
      <div className="absolute right-10 top-10 md:top-20 lg:top-1/4 w-[500px] h-[500px] opacity-30 pointer-events-none">
        <Canvas>
      ...
      >
        <div className="relative w-60 h-60 md:w-72 md:h-72 rounded-full border-8 border-gray-700 shadow-xl overflow-hidden">
          <img
            src={profilePic}
